...
executed—as usually—as soon as it is loaded. You can also add extra js files to 
be included in the showoff.json file. See custom stylesheets below for an example.
...
You can also add a set of files to add in  your showoff.json file:
